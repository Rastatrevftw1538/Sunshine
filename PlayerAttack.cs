    ...
    public class PlayerAttack : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //if (GameManager.instance.runningWindows)
            {
                ...
                if (Input.GetButtonDown(attackButton_Win) && timer >= timeBetweenAttacks && Time.timeScale != 0 && HealthManager.instance.allPlayersAlive && isFire)
                {
                    // ... shoot the gun.
                    Fireball();
                }
           ...
           // {
				...
				if (Input.GetAxis(attackButton_Win)==0)
                {
                    broomPushed = false;
                }
            }
